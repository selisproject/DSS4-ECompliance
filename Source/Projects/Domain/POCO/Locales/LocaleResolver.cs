...
namespace DSS4_ECompliance.Locales
{
    ...
    public class LocaleResolver
    {
        ...
        private static string ReadEmbededResource(string fullPath)
        {
            ...
            var stream = typeof(DSS4_ECompliance.Locales.LocaleResolver).Assembly.GetManifestResourceStream(fullPath);
            if (stream == null)
            {
                stream = typeof(DSS4_ECompliance.Locales.LocaleResolver).Assembly.GetManifestResourceStream("Locales." + fullPath);
            }
            if(stream == null)
            {
                stream = typeof(DSS4_ECompliance.Locales.LocaleResolver).Assembly.GetManifestResourceStream("DSS4_ECompliance."+ "Locales." + fullPath);
            }
            if(stream == null)
            {
                stream = typeof(DSS4_ECompliance.Locales.LocaleResolver).Assembly.GetManifestResourceStream("DSS4_ECompliance."+ "Locales.Locales." + fullPath);
            }
            if(stream == null)
            {
                stream = typeof(DSS4_ECompliance.Locales.LocaleResolver).Assembly.GetManifestResourceStream("DSS4_ECompliance.Backend."+ "Locales.Locales." + fullPath);
            }

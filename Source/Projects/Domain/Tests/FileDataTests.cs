...
namespace DSS4_ECompliance.BoTesting.Tests
{
    ...
    internal class FileDataTests : NHibernateFixture
    {
        ...
        public void FileData_persistence_test()
        {
            ...
            new PersistenceSpecification<DSS4_ECompliance.BO.FileData>(Session)
            .CheckProperty(p => p.FileName, "FileData_FileName")
            .CheckProperty(p => p.FolderPath, "FileData_FolderPath")
            .CheckProperty(p => p.MaxFileSize, 3832)
        ...
        public void FileData_filtering_test()
        {
            ...
            List<DSS4_ECompliance.BO.FileData> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS4_ECompliance.BO.FileData>(
                              a => true
                              ...
                              && a.Blob != null
                              && a.StorageMedium == DSS4_ECompliance.BO.StorageMedium.FileSystem

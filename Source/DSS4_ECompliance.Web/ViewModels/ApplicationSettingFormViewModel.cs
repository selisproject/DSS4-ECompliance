...
using DSS4_ECompliance.UI.Controllers.ApplicationSettingForm;
using AppCode;
...
namespace DSS4_ECompliance.UI.ViewModels.ApplicationSettingForm
{
    ...
    [OriginalType(typeof(DSS4_ECompliance.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel))]
    public class ApplicationSettingFormViewModelDTO : MasterPageForSlideViewModelDTO, IViewModelDTO<DSS4_ECompliance.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel>
    {

        [JsonConstructor]
        public ApplicationSettingFormViewModelDTO() { }
        public ApplicationSettingFormViewModelDTO(DSS4_ECompliance.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS4_ECompliance.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel).FullName;

        public new DSS4_ECompliance.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS4_ECompliance.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS4_ECompliance.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel();
        }
        new  public DSS4_ECompliance.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS4_ECompliance.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS4_ECompliance.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel original)
        {
            if (original == null) return;

...
using DSS4_ECompliance.UI.Controllers.FirstAdminSetup;
using AppCode;
...
namespace DSS4_ECompliance.UI.ViewModels.FirstAdminSetup
{
    ...
    [OriginalType(typeof(DSS4_ECompliance.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel))]
    public class FirstAdminSetupViewModelDTO : MasterPageViewModelDTO, IViewModelDTO<DSS4_ECompliance.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel>
    {

        [JsonConstructor]
        public FirstAdminSetupViewModelDTO() { }
        public FirstAdminSetupViewModelDTO(DSS4_ECompliance.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS4_ECompliance.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel).FullName;

        public new DSS4_ECompliance.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS4_ECompliance.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS4_ECompliance.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel();
        }
        new  public DSS4_ECompliance.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS4_ECompliance.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS4_ECompliance.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel original)
        {
            if (original == null) return;

...
using DSS4_ECompliance.UI.Controllers.ManagePermission;
using AppCode;
...
namespace DSS4_ECompliance.UI.ViewModels.ManagePermission
{
    ...
    [OriginalType(typeof(DSS4_ECompliance.UI.ViewModels.ManagePermission.ManagePermissionViewModel))]
    public class ManagePermissionViewModelDTO : MasterPageForSlideViewModelDTO, IViewModelDTO<DSS4_ECompliance.UI.ViewModels.ManagePermission.ManagePermissionViewModel>
    {

        [JsonConstructor]
        public ManagePermissionViewModelDTO() { }
        public ManagePermissionViewModelDTO(DSS4_ECompliance.UI.ViewModels.ManagePermission.ManagePermissionViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS4_ECompliance.UI.ViewModels.ManagePermission.ManagePermissionViewModel).FullName;
        ...
        public new DSS4_ECompliance.UI.ViewModels.ManagePermission.ManagePermissionViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS4_ECompliance.UI.ViewModels.ManagePermission.ManagePermissionViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS4_ECompliance.UI.ViewModels.ManagePermission.ManagePermissionViewModel();
        }
        new  public DSS4_ECompliance.UI.ViewModels.ManagePermission.ManagePermissionViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS4_ECompliance.UI.ViewModels.ManagePermission.ManagePermissionViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS4_ECompliance.UI.ViewModels.ManagePermission.ManagePermissionViewModel original)
        {
            if (original == null) return;

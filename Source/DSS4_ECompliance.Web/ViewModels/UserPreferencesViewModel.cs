...
using DSS4_ECompliance.UI.Controllers.UserPreferences;
using AppCode;
...
namespace DSS4_ECompliance.UI.ViewModels.UserPreferences
{
    ...
    [OriginalType(typeof(DSS4_ECompliance.UI.ViewModels.UserPreferences.UserPreferencesViewModel))]
    public class UserPreferencesViewModelDTO : MasterPageViewModelDTO, IViewModelDTO<DSS4_ECompliance.UI.ViewModels.UserPreferences.UserPreferencesViewModel>
    {

        [JsonConstructor]
        public UserPreferencesViewModelDTO() { }
        public UserPreferencesViewModelDTO(DSS4_ECompliance.UI.ViewModels.UserPreferences.UserPreferencesViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS4_ECompliance.UI.ViewModels.UserPreferences.UserPreferencesViewModel).FullName;
        ...
        public new DSS4_ECompliance.UI.ViewModels.UserPreferences.UserPreferencesViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS4_ECompliance.UI.ViewModels.UserPreferences.UserPreferencesViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS4_ECompliance.UI.ViewModels.UserPreferences.UserPreferencesViewModel();
        }
        new  public DSS4_ECompliance.UI.ViewModels.UserPreferences.UserPreferencesViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS4_ECompliance.UI.ViewModels.UserPreferences.UserPreferencesViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS4_ECompliance.UI.ViewModels.UserPreferences.UserPreferencesViewModel original)
        {
            if (original == null) return;

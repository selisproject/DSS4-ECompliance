...
using DSS4_ECompliance.UI.Controllers.OperationsList;
using AppCode;
...
namespace DSS4_ECompliance.UI.ViewModels.OperationsList
{
    ...
    [OriginalType(typeof(DSS4_ECompliance.UI.ViewModels.OperationsList.OperationsListViewModel))]
    public class OperationsListViewModelDTO : MasterPageViewModelDTO, IViewModelDTO<DSS4_ECompliance.UI.ViewModels.OperationsList.OperationsListViewModel>
    {

        [JsonConstructor]
        public OperationsListViewModelDTO() { }
        public OperationsListViewModelDTO(DSS4_ECompliance.UI.ViewModels.OperationsList.OperationsListViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS4_ECompliance.UI.ViewModels.OperationsList.OperationsListViewModel).FullName;
        public List<SelectedItemInfo<int?>> ListSelectedItemKeys;

        public new DSS4_ECompliance.UI.ViewModels.OperationsList.OperationsListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS4_ECompliance.UI.ViewModels.OperationsList.OperationsListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS4_ECompliance.UI.ViewModels.OperationsList.OperationsListViewModel();
        }
        new  public DSS4_ECompliance.UI.ViewModels.OperationsList.OperationsListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS4_ECompliance.UI.ViewModels.OperationsList.OperationsListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS4_ECompliance.UI.ViewModels.OperationsList.OperationsListViewModel original)
        {
            if (original == null) return;

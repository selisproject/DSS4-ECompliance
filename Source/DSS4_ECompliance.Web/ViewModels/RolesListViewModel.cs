...
using DSS4_ECompliance.UI.Controllers.RolesList;
using AppCode;
...
namespace DSS4_ECompliance.UI.ViewModels.RolesList
{
    ...
    [OriginalType(typeof(DSS4_ECompliance.UI.ViewModels.RolesList.RolesListViewModel))]
    public class RolesListViewModelDTO : MasterPageViewModelDTO, IViewModelDTO<DSS4_ECompliance.UI.ViewModels.RolesList.RolesListViewModel>
    {

        [JsonConstructor]
        public RolesListViewModelDTO() { }
        public RolesListViewModelDTO(DSS4_ECompliance.UI.ViewModels.RolesList.RolesListViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS4_ECompliance.UI.ViewModels.RolesList.RolesListViewModel).FullName;
        public List<SelectedItemInfo<int?>> ListSelectedItemKeys;

        public new DSS4_ECompliance.UI.ViewModels.RolesList.RolesListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS4_ECompliance.UI.ViewModels.RolesList.RolesListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS4_ECompliance.UI.ViewModels.RolesList.RolesListViewModel();
        }
        new  public DSS4_ECompliance.UI.ViewModels.RolesList.RolesListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS4_ECompliance.UI.ViewModels.RolesList.RolesListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS4_ECompliance.UI.ViewModels.RolesList.RolesListViewModel original)
        {
            if (original == null) return;

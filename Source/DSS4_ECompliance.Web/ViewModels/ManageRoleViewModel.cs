...
using DSS4_ECompliance.UI.Controllers.ManageRole;
using AppCode;
...
namespace DSS4_ECompliance.UI.ViewModels.ManageRole
{
    ...
    [OriginalType(typeof(DSS4_ECompliance.UI.ViewModels.ManageRole.ManageRoleViewModel))]
    public class ManageRoleViewModelDTO : MasterPageForSlideViewModelDTO, IViewModelDTO<DSS4_ECompliance.UI.ViewModels.ManageRole.ManageRoleViewModel>
    {

        [JsonConstructor]
        public ManageRoleViewModelDTO() { }
        public ManageRoleViewModelDTO(DSS4_ECompliance.UI.ViewModels.ManageRole.ManageRoleViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS4_ECompliance.UI.ViewModels.ManageRole.ManageRoleViewModel).FullName;
        public List<SelectedItemInfo<int?>> AddPermissionSelectedItemKeys;

        public new DSS4_ECompliance.UI.ViewModels.ManageRole.ManageRoleViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS4_ECompliance.UI.ViewModels.ManageRole.ManageRoleViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS4_ECompliance.UI.ViewModels.ManageRole.ManageRoleViewModel();
        }
        new  public DSS4_ECompliance.UI.ViewModels.ManageRole.ManageRoleViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS4_ECompliance.UI.ViewModels.ManageRole.ManageRoleViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS4_ECompliance.UI.ViewModels.ManageRole.ManageRoleViewModel original)
        {
            if (original == null) return;

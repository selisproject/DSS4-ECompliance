...
using DSS4_ECompliance.UI.Controllers.UsersList;
using AppCode;
...
namespace DSS4_ECompliance.UI.ViewModels.UsersList
{
    ...
    [OriginalType(typeof(DSS4_ECompliance.UI.ViewModels.UsersList.UsersListViewModel))]
    public class UsersListViewModelDTO : MasterPageViewModelDTO, IViewModelDTO<DSS4_ECompliance.UI.ViewModels.UsersList.UsersListViewModel>
    {

        [JsonConstructor]
        public UsersListViewModelDTO() { }
        public UsersListViewModelDTO(DSS4_ECompliance.UI.ViewModels.UsersList.UsersListViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS4_ECompliance.UI.ViewModels.UsersList.UsersListViewModel).FullName;
        public List<SelectedItemInfo<string>> ListSelectedItemKeys;

        public new DSS4_ECompliance.UI.ViewModels.UsersList.UsersListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS4_ECompliance.UI.ViewModels.UsersList.UsersListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS4_ECompliance.UI.ViewModels.UsersList.UsersListViewModel();
        }
        new  public DSS4_ECompliance.UI.ViewModels.UsersList.UsersListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS4_ECompliance.UI.ViewModels.UsersList.UsersListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS4_ECompliance.UI.ViewModels.UsersList.UsersListViewModel original)
        {
            if (original == null) return;

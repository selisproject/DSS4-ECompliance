...
using DSS4_ECompliance.Security.Owin;
using DSS4_ECompliance.Web.Code;
...
namespace DSS4_ECompliance.Web
{
    public class Startup
    {
        ...
        public void Configuration(IAppBuilder app)
        {
            ...
            DSS4_ECompliance.DatabaseSeeder databaseSeeder = new DSS4_ECompliance.DatabaseSeeder();
            ...
            .Init(typeof(DSS4_ECompliance.DAL.Repository).Assembly);
            DSS4_ECompliance.Hubs.EventsHub.RaiseApplicationStart();

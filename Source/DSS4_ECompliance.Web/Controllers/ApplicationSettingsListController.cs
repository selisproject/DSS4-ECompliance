...
using DSS4_ECompliance.UI.ViewModels.ApplicationSettingsList;
...
namespace DSS4_ECompliance.UI.Controllers.ApplicationSettingsList
{
    ...
    public class ApplicationSettingsListController : ControllerBase<ApplicationSettingsListViewModel, ApplicationSettingsListViewModelDTO>
    {
        ...
        {
            return FileHelper.PendingDownloadInstance.DownloadByKey("ApplicationSettingsList", id);
        }
        ...
        public JsonResult SaveListView()
        {
            ...
            return SaveListView(postedData, "ApplicationSettingsList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return DeleteListView(postedData, "ApplicationSettingsList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return LoadListViews(postedData, "ApplicationSettingsList");
        }
...

        {
            ...
            System.Web.HttpContext.Current.Session["LastEntryPoint_ApplicationSettingsList"] = "Retrieve";
            PushToHistory();
            var _masterController = new DSS4_ECompliance.UI.Controllers.MasterPage.MasterPageController(@model);
        ...
        {
            if (_parentController == null) _parentController = new MasterPage.MasterPageController(new  DSS4_ECompliance.UI.ViewModels.MasterPage.MasterPageViewModel());
        ...
        public IQueryable<zAppDev.DotNet.Framework.Identity.Model.ApplicationSetting> Get_List_DatasourceQueryable(DatasourceRequest __request = null, bool shouldEvict = true)
        {
        ...
        public IQueryable<zAppDev.DotNet.Framework.Identity.Model.ApplicationSetting> Get_List_DatasourceQueryableImplementation(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
        ...
        public JsonResult List_GetFullRecordset()
        {
            ...
            var data = CreateDtoInstancesFromKeys(typeof(ApplicationSettingsListViewModel), dataType, items.Select(i => i.Id.ToString()).ToList(), "List");
...
//Fix for total items in GetGroupsClosed
        ...
        public JsonResult List_DatasourceAggregators()
        {
            ...
            {
                var aggregatorsInfo = DeserializeAggregatorsRequest<zAppDev.DotNet.Framework.Identity.Model.ApplicationSetting>(postedData["aggregatorsRequest"].ToString());
        ...
        public JsonResult List_Export()
        {
            ...
            var aggregatorsInfo = DeserializeAggregatorsRequest<zAppDev.DotNet.Framework.Identity.Model.ApplicationSetting>(exportOptions.AggregatorsRequest);
        ...
        [NonAction]
        public string List_ExportImplementation(DatasourceRequest datasourceRequest, ExportHelper.ExportOptions exportOptions, List<AggregatorInfo<zAppDev.DotNet.Framework.Identity.Model.ApplicationSetting>> aggregatorsInfo)
        {
            ...
            if (exportOptions.ColumnOptions == null)
            {
                ...
                {
                    new ExportHelper.ColumnOptions { Column = "Key", IsVisible = true },
                    new ExportHelper.ColumnOptions { Column = "Value", IsVisible = true },
            ...
            var items = DatasourceRetriever.Retrieve(datasourceRequest, queryable);;
            var dto = items.Select(i => new List1DataSet_ApplicationSettingDTO(i));
            var formattings = new Dictionary<string, string>();
            var aggregators = RuntimePredicateBuilder.BuildAggregatorPredicates(aggregatorsInfo);
            foreach (var a in aggregators)
            {
            ...
            foreach (var record in dto)
            {
                ...
                {
                    ColumnName = nameof(record.Key),
                    Value = record?.Key,
                    ColumnDataType = "string",
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("ApplicationSettingsList", "RES_LIST_List_COLUMN_Key")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ColumnName = nameof(record.Value),
                    Value = record?.Value,
                    ColumnDataType = "string",
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("ApplicationSettingsList", "RES_LIST_List_COLUMN_Value")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("ApplicationSettingsList", "RES_LIST_List_COLUMN_IsCustom")
                });
            ...
            return FileHelper.PendingDownloadInstance.Add("ApplicationSettingsList", content, fileName);
        }
        ...
        [NonAction]
        public string List_ExportV2Implementation(DatasourceRequest datasourceRequest, ExportOptionsV2 exportOptions, List<AggregatorInfo<zAppDev.DotNet.Framework.Identity.Model.ApplicationSetting>> aggregatorsInfo)
        {
            ...
            var formattings = new Dictionary<string, string>();
            var path = "";
            var exportHelper = new ExportHelperV2<zAppDev.DotNet.Framework.Identity.Model.ApplicationSetting>(exportOptions, new Dictionary<string, Func<zAppDev.DotNet.Framework.Identity.Model.ApplicationSetting, object>>
            {
                {"Key" , item => item?.Key }, {"Value" , item => item?.Value }, {"IsCustom" , item => item?.IsCustom },
            });
            if (exportHelper.Options.ColumnInfo == null)
            {
                exportHelper.Options.ColumnInfo = new List<ColumnOptionsV2>
                {
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("ApplicationSettingsList", "RES_LIST_List_COLUMN_Key"), Formatting = "", Name = "Key", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("ApplicationSettingsList", "RES_LIST_List_COLUMN_Value"), Formatting = "", Name = "Value", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("ApplicationSettingsList", "RES_LIST_List_COLUMN_IsCustom"), Formatting = "", Name = "IsCustom", ExcelFormat = @"" },
            ...
            var content = System.IO.File.ReadAllBytes(Path.Combine(Path.GetTempPath(), path));
            var fileName = Path.GetFileName(path);
            var downloadKey = FileHelper.PendingDownloadInstance.Add("ApplicationSettingsList", content, fileName);

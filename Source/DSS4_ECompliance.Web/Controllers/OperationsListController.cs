...
using DSS4_ECompliance.UI.ViewModels.OperationsList;
...
namespace DSS4_ECompliance.UI.Controllers.OperationsList
{
    ...
    public class OperationsListController : ControllerBase<OperationsListViewModel, OperationsListViewModelDTO>
    {
        ...
        {
            return FileHelper.PendingDownloadInstance.DownloadByKey("OperationsList", id);
        }
        ...
        public JsonResult SaveListView()
        {
            ...
            return SaveListView(postedData, "OperationsList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return DeleteListView(postedData, "OperationsList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return LoadListViews(postedData, "OperationsList");
        }
...
// Predefined Ordering
        ...
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            var __items = new DSS4_ECompliance.DAL.Repository().GetAsQueryable<zAppDev.DotNet.Framework.Identity.Model.ApplicationOperation>().AsQueryable();
        ...
        public JsonResult List_GetFullRecordset()
        {
            ...
            var data = CreateDtoInstancesFromKeys(typeof(OperationsListViewModel), dataType, items.Select(i => i.Id.ToString()).ToList(), "List");
...
//Fix for total items in GetGroupsClosed
        ...
        public string List_ExportV2Implementation(DatasourceRequest datasourceRequest, ExportOptionsV2 exportOptions, List<AggregatorInfo<zAppDev.DotNet.Framework.Identity.Model.ApplicationOperation>> aggregatorsInfo)
        {
            ...
            if (exportHelper.Options.ColumnInfo == null)
            {
                ...
                {
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("OperationsList", "RES_LIST_List_COLUMN_ParentControllerName"), Formatting = "", Name = "ParentControllerName", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("OperationsList", "RES_LIST_List_COLUMN_Name"), Formatting = "", Name = "Name", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("OperationsList", "RES_LIST_List_COLUMN_IsAvailableToAllAuthorizedUsers"), Formatting = "", Name = "IsAvailableToAllAuthorizedUsers", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("OperationsList", "RES_LIST_List_COLUMN_IsAvailableToAnonymous"), Formatting = "", Name = "IsAvailableToAnonymous", ExcelFormat = @"" },

...
using DSS4_ECompliance.UI.ViewModels.FirstAdminSetup;
...
namespace DSS4_ECompliance.UI.Controllers.FirstAdminSetup
{
    ...
    public class FirstAdminSetupController : ControllerBase<FirstAdminSetupViewModel, FirstAdminSetupViewModelDTO>
    {
        ...
        {
            ActionResult _result = null;
            zAppDev.DotNet.Framework.Identity.Model.ApplicationRole role = new DSS4_ECompliance.DAL.Repository().GetAsQueryable<zAppDev.DotNet.Framework.Identity.Model.ApplicationRole>((r) => r.Name == "Administrator")?.FirstOrDefault();
            if (role == null)
            {

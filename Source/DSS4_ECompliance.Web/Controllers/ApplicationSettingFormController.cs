...
using DSS4_ECompliance.UI.ViewModels.ApplicationSettingForm;
...
namespace DSS4_ECompliance.UI.Controllers.ApplicationSettingForm
{
    ...
    public class ApplicationSettingFormController : ControllerBase<ApplicationSettingFormViewModel, ApplicationSettingFormViewModelDTO>
    {
        ...
        public ActionResult ExecuteEditApplicationSetting(int? Id)
        {
            ...
            ((MasterPageForSlide.MasterPageForSlideController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.ApplicationSetting =  new DSS4_ECompliance.DAL.Repository().GetById<zAppDev.DotNet.Framework.Identity.Model.ApplicationSetting>(Id);
        ...
        {
            ActionResult _result = null;
            new DSS4_ECompliance.DAL.Repository().Save<zAppDev.DotNet.Framework.Identity.Model.ApplicationSetting>(@model.ApplicationSetting);
            _result = CloseForm();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DSS4_ECompliance.DAL.Repository().DeleteApplicationSetting(@model.ApplicationSetting);
            _result = CloseForm();
            return _result;
        }
        #endregion

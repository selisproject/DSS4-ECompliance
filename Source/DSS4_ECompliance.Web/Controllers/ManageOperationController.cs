...
using DSS4_ECompliance.UI.ViewModels.ManageOperation;
...
namespace DSS4_ECompliance.UI.Controllers.ManageOperation
{
    ...
    public class ManageOperationController : ControllerBase<ManageOperationViewModel, ManageOperationViewModelDTO>
    {
        ...
        {
            ActionResult _result = null;
            new DSS4_ECompliance.DAL.Repository().Save<zAppDev.DotNet.Framework.Identity.Model.ApplicationOperation>(@model.ApplicationOperation);
            _result = CloseForm();
            return _result;
        }
        #endregion

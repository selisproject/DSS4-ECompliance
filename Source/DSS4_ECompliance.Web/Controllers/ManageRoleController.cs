...
using DSS4_ECompliance.UI.ViewModels.ManageRole;
...
namespace DSS4_ECompliance.UI.Controllers.ManageRole
{
    ...
    public class ManageRoleController : ControllerBase<ManageRoleViewModel, ManageRoleViewModelDTO>
    {
        ...
        public ActionResult ExecuteEditRole(int? Id)
        {
            ...
            ((MasterPageForSlide.MasterPageForSlideController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.ApplicationRole =  new DSS4_ECompliance.DAL.Repository().GetById<zAppDev.DotNet.Framework.Identity.Model.ApplicationRole>(Id);
        ...
        {
            ActionResult _result = null;
            new DSS4_ECompliance.DAL.Repository().Save<zAppDev.DotNet.Framework.Identity.Model.ApplicationRole>(@model.ApplicationRole);
            _result = CloseForm();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DSS4_ECompliance.DAL.Repository().DeleteApplicationRole(@model.ApplicationRole);
            _result = CloseForm();
            return _result;
        }
        #endregion

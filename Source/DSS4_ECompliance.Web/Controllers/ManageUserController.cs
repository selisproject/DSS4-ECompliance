...
using DSS4_ECompliance.UI.ViewModels.ManageUser;
...
namespace DSS4_ECompliance.UI.Controllers.ManageUser
{
    ...
    public class ManageUserController : ControllerBase<ManageUserViewModel, ManageUserViewModelDTO>
    {
        ...
        public ActionResult ExecuteEditUser(string Id)
        {
            ...
            ((MasterPageForSlide.MasterPageForSlideController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.ApplicationUser =  new DSS4_ECompliance.DAL.Repository().GetById<zAppDev.DotNet.Framework.Identity.Model.ApplicationUser>(Id);
        ...
        public ActionResult ExecuteSaveUser()
        {
            ...
            {
                new DSS4_ECompliance.DAL.Repository().Save<zAppDev.DotNet.Framework.Identity.Model.ApplicationUser>(@model.ApplicationUser);
            }
            _result = CloseForm();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DSS4_ECompliance.DAL.Repository().DeleteApplicationUser(@model.ApplicationUser);
            _result = CloseForm();
            return _result;
        }

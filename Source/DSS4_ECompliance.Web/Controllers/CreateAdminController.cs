...
using DSS4_ECompliance.UI.ViewModels.CreateAdmin;
...
namespace DSS4_ECompliance.UI.Controllers.CreateAdmin
{
    ...
    public class CreateAdminController : ControllerBase<CreateAdminViewModel, CreateAdminViewModelDTO>
    {
        ...
        {
            var masterViewModel = new DSS4_ECompliance.UI.ViewModels.MasterPageSignIn.MasterPageSignInViewModel
            {
...

        {
            ...
            System.Web.HttpContext.Current.Session["LastEntryPoint_CreateAdmin"] = "Index";
            PushToHistory();
            var _masterController = new DSS4_ECompliance.UI.Controllers.MasterPageSignIn.MasterPageSignInController(@model);
        ...
        {
            if (_parentController == null) _parentController = new MasterPageSignIn.MasterPageSignInController(new  DSS4_ECompliance.UI.ViewModels.MasterPageSignIn.MasterPageSignInViewModel());
        ...
        public ActionResult ExecuteCreate()
        {
            ...
            zAppDev.DotNet.Framework.Identity.Model.ApplicationRole adminRole = new DSS4_ECompliance.DAL.Repository().GetAsQueryable<zAppDev.DotNet.Framework.Identity.Model.ApplicationRole>((r) => r.Name == "Administrator")?.FirstOrDefault();
            if ((adminRole == null))
            {
        ...
        {
            ActionResult _result = null;
            if ((new DSS4_ECompliance.DAL.Repository().GetCount<zAppDev.DotNet.Framework.Identity.Model.ApplicationUser>((u) => u.Roles.Any((r) => r.Name == "Administrator")) > 0))
            {

...
namespace DSS4_ECompliance.ViewModels.ManagePermission {
export class ManagePermissionViewModel extends DSS4_ECompliance.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();

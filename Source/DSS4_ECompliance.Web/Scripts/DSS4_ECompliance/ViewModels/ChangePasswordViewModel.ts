...
namespace DSS4_ECompliance.ViewModels.ChangePassword {
export class ChangePasswordViewModel extends DSS4_ECompliance.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();

...
namespace DSS4_ECompliance.ViewModels.FirstAdminSetup {
export class FirstAdminSetupViewModel extends DSS4_ECompliance.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();

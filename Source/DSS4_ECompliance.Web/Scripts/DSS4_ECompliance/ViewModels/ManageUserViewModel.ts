...
namespace DSS4_ECompliance.ViewModels.ManageUser {
export class ManageUserViewModel extends DSS4_ECompliance.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();

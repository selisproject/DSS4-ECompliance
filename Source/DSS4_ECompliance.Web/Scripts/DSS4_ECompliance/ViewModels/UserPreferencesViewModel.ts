...
namespace DSS4_ECompliance.ViewModels.UserPreferences {
export class UserPreferencesViewModel extends DSS4_ECompliance.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();

...
namespace DSS4_ECompliance.ViewModels.ApplicationSettingForm {
export class ApplicationSettingFormViewModel extends DSS4_ECompliance.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();

...
namespace DSS4_ECompliance.ViewModels.PermissionsList {
export class PermissionsListViewModel extends DSS4_ECompliance.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();

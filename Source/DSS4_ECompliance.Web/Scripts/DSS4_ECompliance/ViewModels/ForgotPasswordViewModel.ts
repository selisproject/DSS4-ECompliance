...
namespace DSS4_ECompliance.ViewModels.ForgotPassword {
export class ForgotPasswordViewModel extends DSS4_ECompliance.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();

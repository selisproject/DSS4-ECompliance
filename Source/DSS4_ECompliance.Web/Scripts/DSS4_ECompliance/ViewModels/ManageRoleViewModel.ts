...
namespace DSS4_ECompliance.ViewModels.ManageRole {
export class ManageRoleViewModel extends DSS4_ECompliance.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();

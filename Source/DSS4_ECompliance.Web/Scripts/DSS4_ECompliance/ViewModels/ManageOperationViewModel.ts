...
namespace DSS4_ECompliance.ViewModels.ManageOperation {
export class ManageOperationViewModel extends DSS4_ECompliance.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();

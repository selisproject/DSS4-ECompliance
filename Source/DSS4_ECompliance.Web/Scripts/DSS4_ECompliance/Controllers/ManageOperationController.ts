...
interface Window { scope_ManageOperation: DSS4_ECompliance.Controllers.IManageOperationScope; }
...
model:
    DSS4_ECompliance.ViewModels.ManageOperation.ManageOperationViewModel;
...
private timeoutDelayLockButton4Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS4_ECompliance.ViewModels.ManageOperation.ManageOperationViewModel._lightCast(window.scope_ManageOperation.model);
    ...
    constructor(private $scope: IManageOperationScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS4_ECompliance.ViewModels.ManageOperation.ManageOperationViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IManageOperationScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS4_ECompliance.ViewModels.ManageOperation.ManageOperationViewModel._initializeFrom(window.viewDTO.Model);

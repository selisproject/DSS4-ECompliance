...
interface Window { scope_SignInPage: DSS4_ECompliance.Controllers.ISignInPageScope; }
...
model:
    DSS4_ECompliance.ViewModels.SignInPage.SignInPageViewModel;
...
private timeoutDelayLockButton2Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS4_ECompliance.ViewModels.SignInPage.SignInPageViewModel._lightCast(window.scope_SignInPage.model);
    ...
    constructor(private $scope: ISignInPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS4_ECompliance.ViewModels.SignInPage.SignInPageViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: ISignInPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS4_ECompliance.ViewModels.SignInPage.SignInPageViewModel._initializeFrom(window.viewDTO.Model);

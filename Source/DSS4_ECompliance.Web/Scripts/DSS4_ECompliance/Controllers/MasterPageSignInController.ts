...
interface Window { scope_MasterPageSignIn: DSS4_ECompliance.Controllers.IMasterPageSignInScope; }
...
class MasterPageSignInController {
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        //
        DSS4_ECompliance.ViewModels.MasterPageSignIn.MasterPageSignInViewModel._lightCast(window.scope_MasterPageSignIn.model);
    ...
    constructor(private $scope: IMasterPageSignInScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS4_ECompliance.ViewModels.MasterPageSignIn.MasterPageSignInViewModel._initializeFrom($scope.model, context);

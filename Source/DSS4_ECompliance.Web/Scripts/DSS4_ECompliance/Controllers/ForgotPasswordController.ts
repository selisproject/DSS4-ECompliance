...
interface Window { scope_ForgotPassword: DSS4_ECompliance.Controllers.IForgotPasswordScope; }
...
model:
    DSS4_ECompliance.ViewModels.ForgotPassword.ForgotPasswordViewModel;
...
private timeoutDelayLockButton11Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS4_ECompliance.ViewModels.ForgotPassword.ForgotPasswordViewModel._lightCast(window.scope_ForgotPassword.model);
    ...
    constructor(private $scope: IForgotPasswordScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS4_ECompliance.ViewModels.ForgotPassword.ForgotPasswordViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IForgotPasswordScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS4_ECompliance.ViewModels.ForgotPassword.ForgotPasswordViewModel._initializeFrom(window.viewDTO.Model);

...
interface Window { scope_RolesList: DSS4_ECompliance.Controllers.IRolesListScope; }
...
model:
    DSS4_ECompliance.ViewModels.RolesList.RolesListViewModel;
...
private timeoutDelayLockEditClicked:
    ...
    constructor(private $scope: IRolesListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS4_ECompliance.ViewModels.RolesList.RolesListViewModel._initializeFrom($scope.model, context);

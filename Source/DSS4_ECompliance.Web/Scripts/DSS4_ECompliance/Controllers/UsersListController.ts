...
interface Window { scope_UsersList: DSS4_ECompliance.Controllers.IUsersListScope; }
...
model:
    DSS4_ECompliance.ViewModels.UsersList.UsersListViewModel;
...
private timeoutDelayLockEditClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS4_ECompliance.ViewModels.UsersList.UsersListViewModel._lightCast(window.scope_UsersList.model);
    ...
    constructor(private $scope: IUsersListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS4_ECompliance.ViewModels.UsersList.UsersListViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IUsersListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS4_ECompliance.ViewModels.UsersList.UsersListViewModel._initializeFrom(window.viewDTO.Model);

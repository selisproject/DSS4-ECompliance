        ...
        var ManagePermissionConditionalFormattings = [
            ...
            new Joove.JbRule({
                ...
                getContext: function (indexes) {
                    var model = window["scope_ManagePermission"].model;
                    var parents = [];
                    try {
                        parents.push(model.ApplicationPermission.Operations);
                    }
                    catch (e) {
                        parents.push({});
                    }
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return _parents[0].IsAvailableToAnonymous; }, false)];
                    });
                }); },
            ...
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return _parents[0].IsAvailableToAllAuthorizedUsers; }, false) == true];
                    });
                }); },
                evaluationTimes: [Joove.EvaluationTimes.OnLoad, Joove.EvaluationTimes.OnSubmit, Joove.EvaluationTimes.OnChange],
                isRelatedToDataValidation: false
        ...
        var ManagePermissionController = (function () {
            function ManagePermissionController($scope, $timeout) {
                ...
                this.controllerActionFinished = function (resetDirty) {
                    ...
                    DSS4_ECompliance.ViewModels.ManagePermission.ManagePermissionViewModel._lightCast(window.scope_ManagePermission.model);
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS4_ECompliance.ViewModels.ManagePermission.ManagePermissionViewModel._initializeFrom($scope.model, context);
                };
            ...
            ManagePermissionController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                $scope.model = DSS4_ECompliance.ViewModels.ManagePermission.ManagePermissionViewModel._initializeFrom(window.viewDTO.Model);

        ...
        var PermissionsListController = (function () {
            function PermissionsListController($scope, $timeout) {
                ...
                this.controllerActionFinished = function (resetDirty) {
                    ...
                    DSS4_ECompliance.ViewModels.PermissionsList.PermissionsListViewModel._lightCast(window.scope_PermissionsList.model);
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS4_ECompliance.ViewModels.PermissionsList.PermissionsListViewModel._initializeFrom($scope.model, context);
                };
            ...
            PermissionsListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                $scope.model = DSS4_ECompliance.ViewModels.PermissionsList.PermissionsListViewModel._initializeFrom(window.viewDTO.Model);
                    ...
                    EditClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockEditClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("ManagePermission", "EditPermission", "GET", [Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItem($("[jb-id='List']"), e).Id; }, 0)], {}, { mode: 'Slide', width: '50%', height: '50%', onClose: function () { $scope.actions.Refresh(); } });
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    }
                };

...
interface Window { scope_HomePage: DSS4_ECompliance.Controllers.IHomePageScope; }
...
model:
    DSS4_ECompliance.ViewModels.HomePage.HomePageViewModel;
...
class HomePageController {
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS4_ECompliance.ViewModels.HomePage.HomePageViewModel._lightCast(window.scope_HomePage.model);
    ...
    constructor(private $scope: IHomePageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS4_ECompliance.ViewModels.HomePage.HomePageViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IHomePageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS4_ECompliance.ViewModels.HomePage.HomePageViewModel._initializeFrom(window.viewDTO.Model);

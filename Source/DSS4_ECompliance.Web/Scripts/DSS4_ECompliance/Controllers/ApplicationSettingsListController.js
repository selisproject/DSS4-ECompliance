        ...
        var ApplicationSettingsListController = (function () {
            function ApplicationSettingsListController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS4_ECompliance.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel._initializeFrom($scope.model, context);
                };
                    ...
                    EditClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockEditClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("ApplicationSettingForm", "EditApplicationSetting", "GET", [Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItem($("[jb-id='List']"), e).Id; }, 0)], {}, { mode: 'Slide', width: '50%', height: '50%', onClose: function () { $scope.actions.Refresh(); } });
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    }
                };

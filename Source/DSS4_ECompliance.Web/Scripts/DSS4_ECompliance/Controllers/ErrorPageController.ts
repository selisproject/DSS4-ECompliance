...
interface Window { scope_ErrorPage: DSS4_ECompliance.Controllers.IErrorPageScope; }
...
model:
    DSS4_ECompliance.ViewModels.ErrorPage.ErrorPageViewModel;
...
private timeoutDelayLockButtonClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS4_ECompliance.ViewModels.ErrorPage.ErrorPageViewModel._lightCast(window.scope_ErrorPage.model);
    ...
    constructor(private $scope: IErrorPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS4_ECompliance.ViewModels.ErrorPage.ErrorPageViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IErrorPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS4_ECompliance.ViewModels.ErrorPage.ErrorPageViewModel._initializeFrom(window.viewDTO.Model);

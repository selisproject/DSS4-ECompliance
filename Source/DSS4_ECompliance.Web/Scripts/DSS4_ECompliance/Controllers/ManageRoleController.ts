...
interface Window { scope_ManageRole: DSS4_ECompliance.Controllers.IManageRoleScope; }
...
model:
    DSS4_ECompliance.ViewModels.ManageRole.ManageRoleViewModel;
...
private timeoutDelayLockButton3Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS4_ECompliance.ViewModels.ManageRole.ManageRoleViewModel._lightCast(window.scope_ManageRole.model);
    ...
    constructor(private $scope: IManageRoleScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS4_ECompliance.ViewModels.ManageRole.ManageRoleViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IManageRoleScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS4_ECompliance.ViewModels.ManageRole.ManageRoleViewModel._initializeFrom(window.viewDTO.Model);

...
interface Window { scope_MasterPageForSlide: DSS4_ECompliance.Controllers.IMasterPageForSlideScope; }
...
class MasterPageForSlideController {
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        //
        DSS4_ECompliance.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel._lightCast(window.scope_MasterPageForSlide.model);
    ...
    constructor(private $scope: IMasterPageForSlideScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS4_ECompliance.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel._initializeFrom($scope.model, context);

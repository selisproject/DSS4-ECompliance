...
interface Window { scope_OperationsList: DSS4_ECompliance.Controllers.IOperationsListScope; }
...
model:
    DSS4_ECompliance.ViewModels.OperationsList.OperationsListViewModel;
...
private timeoutDelayLockEditClicked:
    ...
    constructor(private $scope: IOperationsListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS4_ECompliance.ViewModels.OperationsList.OperationsListViewModel._initializeFrom($scope.model, context);

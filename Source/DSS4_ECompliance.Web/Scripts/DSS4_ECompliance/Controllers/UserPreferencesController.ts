...
interface Window { scope_UserPreferences: DSS4_ECompliance.Controllers.IUserPreferencesScope; }
...
model:
    DSS4_ECompliance.ViewModels.UserPreferences.UserPreferencesViewModel;
...
private timeoutDelayLockCancelBtnClicked:
    ...
    constructor(private $scope: IUserPreferencesScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS4_ECompliance.ViewModels.UserPreferences.UserPreferencesViewModel._initializeFrom($scope.model, context);

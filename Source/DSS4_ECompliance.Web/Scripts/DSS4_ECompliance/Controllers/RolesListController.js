        ...
        var RolesListController = (function () {
            function RolesListController($scope, $timeout) {
                ...
                this.controllerActionFinished = function (resetDirty) {
                    ...
                    DSS4_ECompliance.ViewModels.RolesList.RolesListViewModel._lightCast(window.scope_RolesList.model);
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS4_ECompliance.ViewModels.RolesList.RolesListViewModel._initializeFrom($scope.model, context);
                };
            ...
            RolesListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                $scope.model = DSS4_ECompliance.ViewModels.RolesList.RolesListViewModel._initializeFrom(window.viewDTO.Model);
                    ...
                    EditClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockEditClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("ManageRole", "EditRole", "GET", [Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItem($("[jb-id='List']"), e).Id; }, 0)], {}, { mode: 'Slide', width: '50%', height: '50%', onClose: function () { $scope.actions.Refresh(); } });
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    }
                };

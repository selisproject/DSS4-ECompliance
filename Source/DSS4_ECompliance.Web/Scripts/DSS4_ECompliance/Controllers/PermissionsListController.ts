...
interface Window { scope_PermissionsList: DSS4_ECompliance.Controllers.IPermissionsListScope; }
...
model:
    DSS4_ECompliance.ViewModels.PermissionsList.PermissionsListViewModel;
...
private timeoutDelayLockEditClicked:
    ...
    constructor(private $scope: IPermissionsListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS4_ECompliance.ViewModels.PermissionsList.PermissionsListViewModel._initializeFrom($scope.model, context);

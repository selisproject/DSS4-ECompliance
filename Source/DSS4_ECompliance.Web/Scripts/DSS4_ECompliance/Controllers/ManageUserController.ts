...
interface Window { scope_ManageUser: DSS4_ECompliance.Controllers.IManageUserScope; }
...
model:
    DSS4_ECompliance.ViewModels.ManageUser.ManageUserViewModel;
...
private timeoutDelayLockExitBtnClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS4_ECompliance.ViewModels.ManageUser.ManageUserViewModel._lightCast(window.scope_ManageUser.model);
    ...
    constructor(private $scope: IManageUserScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS4_ECompliance.ViewModels.ManageUser.ManageUserViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IManageUserScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS4_ECompliance.ViewModels.ManageUser.ManageUserViewModel._initializeFrom(window.viewDTO.Model);

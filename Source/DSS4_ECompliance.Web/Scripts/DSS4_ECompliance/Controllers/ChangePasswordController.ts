...
interface Window { scope_ChangePassword: DSS4_ECompliance.Controllers.IChangePasswordScope; }
...
model:
    DSS4_ECompliance.ViewModels.ChangePassword.ChangePasswordViewModel;
...
private timeoutDelayLockButton11Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS4_ECompliance.ViewModels.ChangePassword.ChangePasswordViewModel._lightCast(window.scope_ChangePassword.model);
    ...
    constructor(private $scope: IChangePasswordScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS4_ECompliance.ViewModels.ChangePassword.ChangePasswordViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IChangePasswordScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS4_ECompliance.ViewModels.ChangePassword.ChangePasswordViewModel._initializeFrom(window.viewDTO.Model);

...
interface Window { scope_ManagePermission: DSS4_ECompliance.Controllers.IManagePermissionScope; }
...
model:
    DSS4_ECompliance.ViewModels.ManagePermission.ManagePermissionViewModel;
...
private timeoutDelayLockButton3Clicked:
    ...
    constructor(private $scope: IManagePermissionScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS4_ECompliance.ViewModels.ManagePermission.ManagePermissionViewModel._initializeFrom($scope.model, context);

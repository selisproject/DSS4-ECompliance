        ...
        var OperationsListController = (function () {
            function OperationsListController($scope, $timeout) {
                ...
                this.controllerActionFinished = function (resetDirty) {
                    ...
                    DSS4_ECompliance.ViewModels.OperationsList.OperationsListViewModel._lightCast(window.scope_OperationsList.model);
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS4_ECompliance.ViewModels.OperationsList.OperationsListViewModel._initializeFrom($scope.model, context);
                };
            ...
            OperationsListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                $scope.model = DSS4_ECompliance.ViewModels.OperationsList.OperationsListViewModel._initializeFrom(window.viewDTO.Model);
                    ...
                    EditClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockEditClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("ManageOperation", "EditOperation", "GET", [Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItem($("[jb-id='List']"), e).Id; }, 0)], {}, { mode: 'Slide', width: '50%', height: '50%', onClose: function () { $scope.actions.Refresh(); } });

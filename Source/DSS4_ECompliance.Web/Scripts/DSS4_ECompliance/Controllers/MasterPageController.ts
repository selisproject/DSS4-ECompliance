...
interface Window { scope_MasterPage: DSS4_ECompliance.Controllers.IMasterPageScope; }
...
private timeoutDelayLockMasterSignInMenuItemPressed:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        //
        DSS4_ECompliance.ViewModels.MasterPage.MasterPageViewModel._lightCast(window.scope_MasterPage.model);
    ...
    constructor(private $scope: IMasterPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS4_ECompliance.ViewModels.MasterPage.MasterPageViewModel._initializeFrom($scope.model, context);
